...
const styles = StyleSheet.create({
  ...
  sectionHeader: { flexDirection: "row", alignItems: "center", padding: 14, borderRadius: 12, marginBottom: 12, gap: 8 },
  sectionTitle: { fontSize: 16, fontWeight: "700", flex: 1 },
  sectionCount: { fontSize: 13, color: "#64748b" },
  booksGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  bookItem: { width: "30%", backgroundColor: "#fff", borderRadius: 10, padding: 12, alignItems: "center", borderWidth: 1, borderColor: "#e2e8f0" },
  bookName: { fontSize: 13, fontWeight: "600", color: "#0f172a", textAlign: "center" },
  bookAbbr: { fontSize: 11, color: "#94a3b8", marginTop: 2 },
});
